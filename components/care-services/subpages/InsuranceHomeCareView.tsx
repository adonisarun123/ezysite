        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-[24px] border border-neutral-200 bg-[#FBF3F1] p-7">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#FF385C]">Typically not covered</p>
              <h3 className="mt-3 font-careSerif text-xl font-bold text-neutral-950 sm:text-2xl">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <ol className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {STEPS.map((s) => (
              ...
              >
                <span className="font-careSerif text-3xl font-medium text-[#0074C8]">{s.n}</span>
