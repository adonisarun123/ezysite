      ...
      <section className="bg-white px-4 py-16 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-3xl rounded-[28px] border border-neutral-200 bg-[#F2F7FB] p-8 sm:p-10">
          ...
          <p className="mt-4 font-careSerif text-xl leading-snug text-neutral-900 sm:text-2xl">
            <em className="italic text-[#0074C8]">Live-in</em> is the right choice when the patient cannot
            be alone — alone-living seniors, recent post-discharge, advanced dementia, or bedridden care.{' '}
            <em className="italic text-[#0074C8]">Day shift</em> is right when family is available the rest
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 lg:grid-cols-2">
            {SCENARIOS.map((s) => (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#FF385C]">Situation</p>
