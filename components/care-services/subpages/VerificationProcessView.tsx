      ...
      <section className="bg-white px-4 py-16 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-3xl rounded-[28px] border border-neutral-200 bg-[#F2F7FB] p-8 sm:p-10">
          ...
          <p className="mt-4 font-careSerif text-xl leading-snug text-neutral-900 sm:text-2xl">
            Roughly <em className="italic text-[#0074C8]">one in four</em> applicants make it through.
            ...
            <div className="lg:col-span-7">
              <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {DISQUALIFIERS.map((d) => (
                  <li
                    key={d}
                    className="flex items-start gap-2 rounded-2xl border border-[#FF385C]/20 bg-white px-4 py-3.5"
                  >
