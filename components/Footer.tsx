              ...
              <div className="pt-8 border-t border-gray-700">
                ...
                <div className="flex space-x-4">
                  ...
                  <Link 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                    aria-label="Follow us on Instagram"
                  >
                    <svg className="w-5 h-5 text-gray-300 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.328-1.297C4.243 14.814 3.75 13.663 3.75 12.366c0-1.297.493-2.448 1.371-3.328.878-.879 2.031-1.371 3.328-1.371 1.297 0 2.448.492 3.328 1.371.879.88 1.371 2.031 1.371 3.328 0 1.297-.492 2.448-1.371 3.325-.88.807-2.031 1.297-3.328 1.297zm7.718-7.718c-.293 0-.586-.293-.586-.586 0-.293.293-.586.586-.586s.586.293.586.586c0 .293-.293.586-.586.586zm-4.167 6.164c1.004 0 1.812-.808 1.812-1.812s-.808-1.812-1.812-1.812-1.812.808-1.812 1.812.808 1.812 1.812 1.812zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                  ...
                  <Link 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-800 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
      ...
      <div className="border-t border-white/5 bg-gray-900/40">
        <div className="px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
          <div className="mx-auto max-w-7xl">
            ...
            {/* Trustpilot widget — silently absent until reviews are seeded.
                The TrustpilotClient's bootstrap script populates this if/when
                the business unit has live reviews; otherwise nothing shows
