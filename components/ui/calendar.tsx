  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-rose-600 text-slate-50 hover:bg-rose-600 hover:text-slate-50 focus:bg-rose-600 focus:text-slate-50 dark:bg-rose-600 dark:text-slate-50 dark:hover:bg-rose-600 dark:hover:text-slate-50 dark:focus:bg-rose-600 dark:focus:text-slate-50",
