...
export default async function FarmhouseCoupleJobsOdishaBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/live-in-couple-farmhouse-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/live-in-couple-farmhouse-job-bangalore", faqs)
    return (
        <>
            <JobPostingSchema
                title="Live-in Couple For Farmhouse Jobs in Bangalore"
