        ...
        <>
            <main className="min-h-screen">
                ...
                <section className="relative bg-gradient-to-br from-violet-800 via-violet-500 to-violet-700 text-white pt-8 pb-12 md:pt-20 md:pb-24 lg:pb-8 overflow-hidden">
                    ...
                    <div className="container-custom relative z-10 font-bold italic">
                        <div className="w-full max-w-none mx-auto text-center px-4">
                            <h1 className="text-xl md:text-5xl lg:text-5xl font-bold mb-2 font-display leading-tight text-white whitespace-normal italic">Farmhouse Jobs in Bangalore for Couples from Odisha</h1>

                            <div className="space-y-4 mb-6 max-w-5xl mx-auto mt-4 font-bold italic leading-relaxed">
                            ...
                            <div className="flex flex-wrap justify-center gap-2 max-w-5xl mx-auto px-1 font-bold italic">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center mt-8 gap-4 px-4 max-w-md mx-auto sm:max-w-none font-bold italic">
                                <Link
                    ...
                    <div className="container-custom">
                        ...
                        <div className="bg-violet-50 rounded-3xl p-8 md:p-12 shadow-xl border border-violet-100 max-w-6xl mx-auto">
                            <div className="text-center mb-8 italic">
                                ...
                                <div className="w-24 h-1 bg-violet-500 mx-auto mt-4 rounded-full italic font-bold"></div>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 font-bold italic leading-tight">
                                {[
                                    ...
                                    <div key={index} className={`flex items-center gap-4 bg-white p-4 rounded-xl border border-violet-100 shadow-sm font-bold italic`}>
                                        <div className="w-10 h-10 rounded-full bg-violet-100 flex items-center justify-center flex-shrink-0 font-bold italic leading-tight">
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-display italic">Live-In Farmhouse Jobs in Bangalore for Couples</h2>
                    ...
                    <div className="container-custom font-bold italic">
                        <div className="bg-gradient-to-br from-violet-800 to-violet-900 rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden font-bold italic">
                            ...
                            <div className="relative z-10 font-bold italic">
                                    ...
                                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-violet-700/50 lg:col-span-2 font-bold italic leading-relaxed">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-sm md:text-base text-violet-50 font-bold italic leading-relaxed">
                                            <ul className="space-y-3 font-bold italic leading-relaxed">
                                                ...
                                                <li className="flex items-start gap-2 italic">
                                                    <div className="w-1.5 h-1.5 rounded-full bg-violet-300 mt-2 flex-shrink-0 font-bold italic leading-relaxed"></div>
                                                    <span className="leading-tight italic">Training aligned with Sector Skill Council (DWSSC)</span>
                                                </li>
                                                <li className="flex items-start gap-2 italic">
                                                    <div className="w-1.5 h-1.5 rounded-full bg-violet-300 mt-2 flex-shrink-0 font-bold italic leading-relaxed"></div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-violet-900/50 rounded-2xl p-6 border border-violet-700/50 backdrop-blur-sm font-bold italic leading-relaxed">
                                    <div className="flex items-center gap-4 italic font-bold leading-relaxed">
                                        <div className="w-12 h-12 bg-violet-800 rounded-full flex items-center justify-center flex-shrink-0 border border-violet-600 text-violet-300 shadow-lg font-bold italic leading-relaxed">
                ...
                <section className="section-padding bg-gray-50 font-bold italic leading-relaxed">
                    <div className="container-custom font-bold italic leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto font-bold italic leading-relaxed">
                            {[
                                ...
                                <div key={index} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 group italic font-bold leading-relaxed">
                ...
                {/* NEST Hostel Section */}
                <section className="section-padding bg-white relative overflow-hidden font-bold italic leading-relaxed">
                    <div className="absolute inset-0 bg-gradient-to-br from-pink-50 to-white -z-10 font-bold italic leading-relaxed" />
                    <div className="container-custom font-bold italic leading-relaxed">
                        <div className="max-w-4xl mx-auto font-bold italic leading-relaxed">
                            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-pink-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12 group italic font-bold leading-relaxed">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-pink-100 rounded-full blur-3xl opacity-60 -mr-16 -mt-16 group-hover:scale-110 transition-transform font-bold italic leading-relaxed"></div>
                                <div className="absolute bottom-0 left-0 w-32 h-32 bg-pink-50 rounded-full blur-3xl opacity-60 -ml-16 -mb-16 font-bold italic leading-relaxed"></div>

                                <div className="flex-shrink-0 relative z-10 w-full md:w-auto flex justify-center italic font-bold leading-relaxed">
                                    <div className="w-24 h-24 md:w-32 md:h-32 bg-pink-50 rounded-full flex items-center justify-center border-4 border-white shadow-lg group-hover:rotate-12 transition-transform italic font-bold leading-relaxed">
                                        <OutlineHomeModernIcon className="w-12 h-12 md:w-16 md:h-16 text-pink-500 font-bold italic leading-relaxed" />
                                    </div>
                                </div>
                ...
                <section className="section-padding bg-gray-50 font-bold italic leading-relaxed">
                    <div className="container-custom font-bold italic leading-relaxed text-center">
                        ...
                        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 font-bold italic leading-relaxed text-center">
                            {[
