...
export default async function FarmhouseCoupleJobsOdishaBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/live-in-couple-farmhouse-job-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/live-in-couple-farmhouse-job-bangalore/hin", faqs)
    return (
        <>
