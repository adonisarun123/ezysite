                ...
                <section className="relative bg-gradient-to-br from-violet-800 via-violet-500 to-violet-700 text-white pt-8 pb-12 md:pt-20 md:pb-24 lg:pb-8 overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        <div className="w-full max-w-none mx-auto text-center px-4">
                            <h1 className="text-xl md:text-5xl lg:text-5xl font-bold mb-2 font-display leading-tight text-white whitespace-normal italic leading-tight">ओडिशा के कपल्स के लिए बैंगलोर में फार्महाउस जॉब्स</h1>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="text-center mb-12 px-4">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-display italic leading-tight italic">बैंगलोर में 24 घंटे रहने वाले पति-पत्नी के लिए फार्महाउस जॉब</h2>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-600 font-bold uppercase tracking-widest text-xs md:text-sm max-w-2xl mx-auto italic leading-relaxed text-center italic">सैलरी संपत्ति के आकार, अनुभव और जिम्मेदारियों पर निर्भर करती है।</p>
                            <div className="w-24 h-1 bg-violet-500 mx-auto mt-6 rounded-full opacity-50"></div>
                        </div>
                ...
                <section className="section-padding bg-gray-50 font-bold italic">
                    <div className="container-custom font-bold italic">
                        <div className="text-center mb-16 px-4 font-bold italic">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-display italic leading-tight italic font-bold">फार्महाउस जॉब्स के लिए अप्लाई कैसे करें</h2>
                            <p className="text-gray-600 max-w-2xl mx-auto font-bold uppercase tracking-widest text-xs md:text-sm text-center italic leading-relaxed italic font-bold italic font-bold">ईज़ीहेल्पर्स से संपर्क करें - 6 आसान कदम</p>
                            <div className="w-24 h-1 bg-violet-500 mx-auto mt-6 rounded-full opacity-50 font-bold italic"></div>
                        </div>
                        ...
                        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 font-bold italic">
                            {[
                                ...
                                <div key={index} className="bg-white rounded-2xl p-6 border border-gray-100 relative group hover:shadow-xl transition-all duration-300 italic font-bold">
                                    ...
                                    <p className="text-gray-600 text-xs font-bold leading-relaxed italic leading-relaxed font-bold italic leading-relaxed font-bold italic">{item.desc}</p>
                                </div>
                            ))}
                        </div>
