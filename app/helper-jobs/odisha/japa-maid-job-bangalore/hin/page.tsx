        ...
        <>
            <div lang="hi" className="min-h-screen noto-sans-devanagari-hindi">
                    ...
                    <div className="container-custom">
                        ...
                        <div className="bg-violet-50 rounded-3xl p-8 md:p-12 shadow-xl border border-violet-100 max-w-6xl mx-auto">
                            <div className="text-center mb-8">
                                <h3 className="text-xl md:text-4xl font-bold text-gray-900 font-display italic">ईज़ीहेल्पर्स को क्या अलग बनाता है</h3>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center mb-12 px-4">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-display italic leading-tight">माँ और नवजात शिशु की देखभाल का काम की जिम्मेदारियाँ</h2>
                            <p className="text-gray-600 font-bold max-w-3xl mx-auto italic leading-relaxed">जापा मेड का काम मुख्य रूप से माँ और नवजात शिशु की देखभाल से जुड़ा होता है।</p>
                            <div className="w-24 h-1 bg-violet-500 mx-auto mt-6 rounded-full opacity-50"></div>
                        </div>
                        ...
                        <div className="max-w-4xl mx-auto overflow-hidden rounded-[3rem] border border-gray-200 shadow-2xl bg-white relative">
                            ...
                            <table className="w-full text-left relative z-10">
                                <thead className="bg-violet-600 text-white">
                                    <tr>
                                        <th className="p-6 font-bold uppercase tracking-widest text-xs md:text-sm italic">विवरण</th>
                                        <th className="p-6 font-bold uppercase tracking-widest text-xs md:text-sm text-center italic">जानकारी</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                                    <tr className="hover:bg-violet-50 transition-colors">
                                        <td className="p-6 font-bold text-gray-900 italic">जॉब टाइप</td>
                                        <td className="p-6 font-bold text-gray-900 text-center italic">लिव-इन माँ और नवजात शिशु की देखभाल</td>
                                    </tr>
                                    <tr className="hover:bg-violet-50 transition-colors">
                                        <td className="p-6 font-bold text-gray-900 italic">महीने की सैलरी</td>
                                        <td className="p-6 font-bold text-violet-700 text-lg md:text-3xl text-center">₹25,000 से ₹30,000</td>
                                    </tr>
                                    <tr className="hover:bg-violet-50 transition-colors">
                                        <td className="p-6 font-bold text-gray-900 italic">रहना</td>
                                        <td className="p-6 font-bold text-gray-600 text-center italic">शामिल</td>
                                    </tr>
                                    <tr className="hover:bg-violet-50 transition-colors">
                                        <td className="p-6 font-bold text-gray-900 italic">खाना</td>
                                        <td className="p-6 font-bold text-gray-600 text-center italic">शामिल</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom max-w-4xl">
                        <div className="text-center mb-12 px-4">
                            ...
                            <p className="text-gray-600 font-bold max-w-2xl mx-auto italic leading-relaxed text-center">बैंगलोर में माँ और नवजात शिशु की देखभाल करने वाला काम के लिए अप्लाई किया जा सकता है अगर:</p>
                            <div className="w-24 h-1 bg-violet-500 mx-auto mt-6 rounded-full opacity-50"></div>
                        </div>
                ...
                {/* NEST Hostel Section */}
                <section className="section-padding bg-gray-50 relative overflow-hidden font-bold italic">
