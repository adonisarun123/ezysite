...
export default async function HomeCookJobsOdishaBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/home-cook-jobs-in-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/home-cook-jobs-in-bangalore", faqs)
    return (
        <>
