...
export default async function HomeCookJobsOdishaBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/home-cook-jobs-in-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/home-cook-jobs-in-bangalore/hin", faqs)
    return (
        <>
