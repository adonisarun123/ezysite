...
export default async function CoupleSecurityJobsOdishaBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/couple-security-job-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/couple-security-job-bangalore/hin", faqs)
    return (
        <>
