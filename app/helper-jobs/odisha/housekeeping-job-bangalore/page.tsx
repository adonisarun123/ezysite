...
export default async function HousekeepingJobsOdishaBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/odisha/housekeeping-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/odisha/housekeeping-job-bangalore", faqs)
    return (
        <>
