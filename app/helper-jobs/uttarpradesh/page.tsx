                            ...
                            <div className="md:flex">
                                ...
                                <div className="md:w-7/12 p-8 md:p-10 flex flex-col justify-center">
                                    <p className="text-lg md:text-xl text-gray-800 font-bold mb-6">
                                        Do you have a sister, friend, or neighbour from Uttar Pradesh looking for work in Bangalore?
                                    </p>
                                    ...
                                    <div className="bg-amber-50 text-amber-700 font-black text-sm md:text-base py-3 px-6 rounded-xl text-center border border-amber-100 uppercase tracking-tight">
