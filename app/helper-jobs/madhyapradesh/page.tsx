...
export default async function HelperJobsMPPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/madhyapradesh")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/madhyapradesh", faqs)
    return (
        <>
