...
export default async function HelperJobsTelanganaPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/telangana")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/telangana", faqs)
    return (
        <>
                ...
                <Breadcrumb
                    ...
                    rightContent={
                        <div className="flex items-center space-x-2 text-sm bg-white px-3 py-1 pb-1.5 rounded-full shadow-sm shrink-0">
                            ...
                            <Link
                                href="/helper-jobs/telangana/hin"
