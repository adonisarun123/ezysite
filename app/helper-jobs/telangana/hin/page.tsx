...
export default async function HelperJobsTelanganaHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/telangana/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/telangana/hin", faqs)
    return (
        <>
