                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                            {[
                                ...
                                },
                                {
                                    slug: "assam",
                                    title: "असम",
                                    desc: "बैंगलोर में भरोसेमंद हेल्पर जॉब्स के साथ अपनी कमाई बढ़ाएं। डायरेक्ट हायरिंग, फ्री रजिस्ट्रेशन और सुरक्षित मेड जॉब्स पाएं।",
                                    features: ["मालिक से डायरेक्ट सैलरी", "लिखित एग्रीमेंट से सुरक्षा", "सपोर्ट टीम हमेशा साथ", "फ्री रजिस्ट्रेशन - 100% कमाई आपकी", "सुरक्षित काम का माहौल"]
                                },
                                {
                                    slug: "bihar",
                                    title: "बिहार",
                                    desc: "बिहार में कम सैलरी वाली प्राइवेट जॉब्स छोड़ें। बैंगलोर में स्थिर हाउस हेल्पर जॉब्स और बेहतर सैलरी के साथ सम्मानजनक जीवन जिएं।",
                                    features: ["कुक, मेड और केयरगिवर जॉब्स", "समय पर डायरेक्ट सैलरी पेमेंट", "स्पष्ट वर्क कॉन्ट्रैक्ट हर बार", "सम्मानजनक फैमिली माहौल", "कोई एजेंट कमीशन नहीं"]
                                },
                                {
                                    slug: "chhattisgarh",
                                    title: "छत्तीसगढ़",
                                    desc: "बिना आराम के लंबे काम के घंटों को भूल जाइए; EzyHelpers आपको फिक्स्ड टाइमिंग और सुरक्षित काम का माहौल देता है।",
                                    features: ["सफाई, खाना बनाना और घरेलू मदद", "फुल-TIME और लिव-इन पोजीशन", "फिक्स्ड काम के घंटे", "जॉइन करने के बाद भी सपोर्ट", "सुरक्षित और भरोसेमंद घर"]
                                },
                                {
                                    slug: "uttarpradesh",
                                    title: "उत्तर प्रदेश",
                                    desc: "धोखेबाज़ लोकल एजेंटों से बचें। लिखित एग्रीमेंट और पूरी सुरक्षा के साथ बैंगलोर में सुरक्षित हाउस मेड जॉब्स के लिए अभी अप्लाई करें।",
                                    features: ["हाउसकीपिंग, कुकिंग और नैनी रोल", "परिवार से डायरेक्ट सैलरी पेमेंट", "सुरक्षा के लिए लिखित एग्रीमेंट", "हेल्पर्स के लिए फ्री ट्रेनिंग", "सम्मानजनक और सुरक्षित वर्कप्लेस"]
                                },
                                {
                                    slug: "uttarakhand",
                                    title: "उत्तराखंड",
                                    desc: "कम सैलरी वाली जॉब्स छोड़ें। बैंगलोर में सम्मान, सुरक्षा और लोकल काम से बेहतर सैलरी के साथ पक्की मेड जॉब्स पाएं।",
                                    features: ["कई मेड जॉब्स के मौके", "प्राइवेट रूम और सुरक्षित स्टे", "डायरेक्ट बैंक ट्रांसफर सैलरी", "कोई एजेंट कमीशन नहीं", "स्किल्स के आधार पर जॉब मैच"]
                                },
                                {
                                    slug: "madhyapradesh",
                                    title: "मध्य प्रदेश",
                                    desc: "बैंगलोर में सुरक्षित होम वर्क जॉब्स चुनें जहाँ आप इज्जतदार परिवारों के साथ काम करेंगे और EzyHelpers से पूरा सपोर्ट पाएंगे।",
                                    features: ["हाउसकीपर, कुक और नैनी रोल", "जॉइन करने से पहले परिवार से बात", "समय पर फिक्स्ड मंथली पेमेंट", "सपोर्ट टीम हमेशा उपलब्ध", "सुरक्षित काम का माहौल"]
                                },
                                {
                                    slug: "andhrapradesh",
                                    title: "आंध्र प्रदेश",
                                    desc: "बैंगलोर के भरोसेमंद परिवारों से जुड़ें। जॉब चुनने का हक, जॉइनिंग से पहले वीडियो कॉल और फिक्स्ड मंथली पेमेंट की सुविधा।",
                                    features: ["फ्लेक्सिबल हाउसहोल्ड जॉब रोल", "डायरेक्ट बैंक ट्रांसफर सैलरी", "परिवार के साथ वीडियो कॉल इंटरव्यू", "महिलाओं के लिए इमरजेंसी स्टे", "सपोर्ट टीम की हमेशा मदद"]
                                },
                                {
                                    slug: "telangana",
                                    title: "तेलंगाना",
