...
export default async function HelperJobsAndhraHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/andhrapradesh/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/andhrapradesh/hin", faqs)
    return (
        <>
