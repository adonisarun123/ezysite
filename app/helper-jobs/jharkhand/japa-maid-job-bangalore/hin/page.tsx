...
export default async function JapaMaidJobBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/jharkhand/japa-maid-job-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/jharkhand/japa-maid-job-bangalore/hin", faqs)
    return (
        <>
            <div lang="hi" className="min-h-screen noto-sans-devanagari-hindi">
                ...
                {/* Refer & Earn Section */}
                <ReferEarnSection variant="pink" location="झारखंड" lang="hi" />
