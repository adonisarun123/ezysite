...
export default async function JapaMaidJobBangalorePage() {
  ...
  const faqItems = await getHelperJobFaqs("helper-jobs/jharkhand/japa-maid-job-bangalore", faqs)
    return (
        <>
            <JobPostingSchema
                title="Japa Maid Jobs in Bangalore"
                description="Live-in Japa maid / newborn care jobs in Bangalore for experienced women from Jharkhand. Safe homes, food, accommodation, and direct employer support."
            ...
            <main className="min-h-screen">
                ...
                {/* Refer & Earn Section */}
                <ReferEarnSection variant="pink" location="Jharkhand" lang="en" />
