...
export default async function PatientCareJobsBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/jharkhand/patient-care-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/jharkhand/patient-care-job-bangalore", faqs)
    return (
        <>
            <JobPostingSchema
