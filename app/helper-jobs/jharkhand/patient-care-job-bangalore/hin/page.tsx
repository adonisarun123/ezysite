...
export default async function PatientCareJobsBangaloreHinPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/jharkhand/patient-care-job-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/jharkhand/patient-care-job-bangalore/hin", faqs)
    return (
        <>
