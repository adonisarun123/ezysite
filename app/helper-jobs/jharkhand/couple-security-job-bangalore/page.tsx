...
export default async function CoupleSecurityJobsBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/jharkhand/couple-security-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/jharkhand/couple-security-job-bangalore", faqs)
    return (
        <>
            <JobPostingSchema
