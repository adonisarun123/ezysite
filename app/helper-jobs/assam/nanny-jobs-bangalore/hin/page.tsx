...
export default async function NannyJobsAssamBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/nanny-jobs-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/nanny-jobs-bangalore/hin", faqs)
    return (
        <>
