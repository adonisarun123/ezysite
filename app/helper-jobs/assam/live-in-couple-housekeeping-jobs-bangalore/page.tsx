...
export default async function LiveInCoupleHousekeepingJobsAssamBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/live-in-couple-housekeeping-jobs-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/live-in-couple-housekeeping-jobs-bangalore", faqs)
    return (
        <>
