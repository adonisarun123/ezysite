...
export default async function LiveInCoupleHousekeepingJobsAssamBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/live-in-couple-housekeeping-jobs-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/live-in-couple-housekeeping-jobs-bangalore/hin", faqs)
    return (
        <>
