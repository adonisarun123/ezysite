...
export default async function JapaMaidJobsAssamBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/japa-maid-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/japa-maid-job-bangalore", faqs)
    return (
        <>
