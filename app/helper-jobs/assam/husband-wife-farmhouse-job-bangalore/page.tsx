                ...
                <Breadcrumb
                    ...
                    rightContent={
                        <div className="flex gap-2">
                            <span className="text-xs font-bold bg-amber-100 text-amber-800 px-2 py-1 rounded-md">English</span>
                            <Link href="/helper-jobs/assam/husband-wife-farmhouse-job-bangalore/hin" className="text-xs font-medium text-gray-500 hover:text-slate-600 transition-colors px-2 py-1 rounded-md hover:bg-slate-50">हिन्दी</Link>
                        </div>
                    }
                />
                ...
                <section className="relative bg-gradient-to-br from-amber-700 via-amber-600 to-amber-800 text-white pt-8 pb-12 md:pt-20 md:pb-24 lg:pb-8 overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        <div className="w-full max-w-none mx-auto text-center px-4">
                            <h1 className="text-xl md:text-5xl lg:text-5xl font-bold mb-2 font-display leading-tight text-white whitespace-normal">Husband-wife Farmhouse Job in Bangalore for Assam Helpers</h1>
                            <p className="text-sm md:text-xl text-amber-100/90 leading-relaxed max-w-4xl mx-auto mb-8 font-medium">
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <p className="text-center font-bold text-amber-800">We explain all work responsibilities clearly before you start the job.</p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto bg-amber-50 rounded-3xl p-8 md:p-12 border border-amber-200 text-center relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-md font-bold text-amber-800 mb-8 max-w-2xl mx-auto">
