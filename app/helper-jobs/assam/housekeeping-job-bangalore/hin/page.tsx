...
export default async function HousekeepingJobsAssamBangaloreHindiPage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/housekeeping-job-bangalore/hin")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/housekeeping-job-bangalore/hin", faqs)
    return (
        <>
