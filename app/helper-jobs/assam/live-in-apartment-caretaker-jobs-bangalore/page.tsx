...
export default async function ApartmentCaretakerJobsAssamBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/live-in-apartment-caretaker-jobs-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/live-in-apartment-caretaker-jobs-bangalore", faqs)
    return (
        <>
