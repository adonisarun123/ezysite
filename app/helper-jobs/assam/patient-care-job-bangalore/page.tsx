...
export default async function PatientCareJobsAssamBangalorePage() {
  const __dbHtml = await getHtmlContent("helper-jobs/assam/patient-care-job-bangalore")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const faqItems = await getHelperJobFaqs("helper-jobs/assam/patient-care-job-bangalore", faqs)
    return (
        <>
