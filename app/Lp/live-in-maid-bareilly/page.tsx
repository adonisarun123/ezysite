...
// canonical /services/live-in-maids and /cities/bareilly/live-in-maid pages.
export const metadata: Metadata = {
  title: 'Live-In Maid in Bareilly | EzyHelpers',
  description: 'Hire a verified live-in maid in Bareilly for daily home support. Background-checked helpers and free replacement support.',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://www.ezyhelpers.com/cities/bareilly/live-in-maid' },
}

export default function LiveInMaidBareillyPage() {
    const features = [
        {
    ...
    const services = [
        {
            ...
            description: 'Our stay-at-home maids in Bareilly take care of all daily housework. They keep your home clean, neat, and well-organised.',
            icon: HomeIcon,
            details: [
        ...
        },
        {
            ...
            description: 'We provide trained and gentle babysitters for 24-hour home help in Bareilly who take care of your little ones with love and patience.',
            icon: UserGroupIcon,
            details: [
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'EzyHelpers offers transparent monthly pricing for a live-in housemaid in Bareilly with no hidden fees. The exact cost depends on the specific services required. Contact EzyHelpers for detailed pricing based on your household needs.'
        },
        {
            id: 'faq4',
        ...
        },
        {
            ...
            answer: "For a Live-in housemaid in Bareilly, you need to provide a room, private or shared, with basic facilities like a bed, mattress or cot, along with access to a bathroom. These arrangements ensure the maid's comfort and maintain your family's privacy."
        },
        {
            id: 'faq6',
    ...
    return (
        <main className="min-h-screen bg-white font-sans selection:bg-success-100 selection:text-success-900">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="pt-4">
                            ...
                            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight font-display">
                                Hire Verified <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-300 to-success-300">Live-In Maids</span> in Bareilly
                            </h1>
                        ...
                        <div className="relative z-10">
                            <AdLeadForm city="Bareilly" trackingEvent="live_in_maid_bareilly_ad" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-primary-600 text-white text-center relative overflow-hidden">
                ...
                <div className="container-custom relative z-10">
                    <h2 className="text-3xl text-white md:text-5xl font-bold mb-6 font-display leading-tight">
                        Get a Trusted Live-In House Maid in Bareilly
                    </h2>
                    <p className="text-xl text-primary-100 mb-10 max-w-2xl mx-auto font-light">
                        Reduce your daily workload with experienced and verified Live-in housemaids in Bareilly. EzyHelpers ensures trained, verified helpers who adapt easily to your home, habits, and schedule.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/hire-helper" className="bg-white text-primary-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 hover:shadow-lg transition-all shadow-xl">
                            Book a Live-In Maid
                        </Link>
            ...
            <section className="py-16 bg-gradient-to-r from-primary-900 to-primary-800 text-white">
                <div className="mx-auto px-4 max-w-[1440px] text-center">
