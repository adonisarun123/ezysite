  ...
  const services = [
    {
      ...
      description: 'Our full-time maids in Bangalore take care of all daily housework. They keep your home clean, neat, and well-organised.',
      icon: HomeIcon,
      details: [
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="pt-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight font-display">
                Hire Verified <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-300 to-success-300">Full-Time Maids</span> in Bangalore
              </h1>
              <p className="text-xl text-primary-100 mb-8 leading-relaxed font-light">
                Background-checked maids for 8–10 hours of daily housekeeping, cooking & child/elder care. <span className="text-white font-medium">Quick joining in 48-72 hours.</span>
              </p>
            ...
            <div className="relative z-10">
              <AdLeadForm city="Bangalore" trackingEvent="full_time_maid_bangalore_ad" serviceType="full-time" messagePlaceholder="I need a full-time maid for..." />
            </div>
          </div>
        </div>
      </section>
