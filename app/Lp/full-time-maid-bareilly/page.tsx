  ...
  const features = [
    {
      ...
      description: 'Every full-time maid undergoes ID verification and local address checks for your safety.',
      icon: ShieldCheckIcon
    },
    {
      title: 'Quick Joining in 48-72 Hours',
      description: 'Your verified full-time maid starts work within two to three days after profile selection and confirmation.',
      icon: ClockIcon
    },
    {
      title: 'Hassle-Free Replacement',
      description: 'Not satisfied with your full-time maid? We provide quick and smooth replacements at no extra cost to you.',
      icon: ArrowPathIcon
    },
    {
      title: 'Regular Follow-Up Support',
      description: 'We follow up regularly with you and your maid to ensure smooth daily service and satisfaction.',
      icon: PhoneIcon
    }
  ]
  ...
  const services = [
    {
      ...
      description: 'Our full-time maids in Bareilly take care of all daily housework. They keep your home clean, neat, and well-organised.',
      icon: HomeIcon,
      details: [
    ...
    {
      title: 'Cook-cum-Maid',
      description: 'A full-time maid who cooks fresh daily meals for your family and also handles light housekeeping around the kitchen and home.',
      icon: UserGroupIcon,
      details: [
        'Breakfast & lunch/dinner preparation',
        'Veg or non-veg cooking as needed',
        'Kitchen cleanup after cooking',
        'Help with grocery lists & prep work',
        'Light housekeeping support'
      ]
    },
    {
      title: 'Child & Elder Support',
      description: 'Caring full-time helpers who look after your children or elders during the day with patience and attention.',
      icon: HeartIcon,
      details: [
        'School-time child care & feeding',
        'Hygiene help for kids',
        'Elder companionship & conversation',
        'Medicine reminders on time',
        'Daytime supervision & safety'
      ]
    }
  ]
  ...
  const steps = [
    {
      ...
      description: 'Tell us your requirements— cleaning, cooking, child care, or elder support.'
    },
    {
    ...
    },
    {
      ...
      description: 'Speak to your shortlisted full-time maids via phone or video call.'
    },
    {
      title: 'Maid Starts Work',
      description: 'Your full-time maid starts within 48-72 hours, working 8-10 hours daily. We stay connected for support.'
    }
  ]

  const areas = [
    'Civil Lines', 'Rampur Garden', 'Rajendra Nagar', 'Prem Nagar', 'Cantt', 'Indira Nagar', 'Ekta Nagar', 'Karamchari Nagar', 'and many more...'
  ]

  const faqs = [
    {
      id: 'faq1',
      question: 'What are the working hours of a full-time maid?',
      answer: 'A full-time maid works 8–10 hours a day and goes back to her home at night. The exact timings are agreed upfront with you—for example, 8 AM to 6 PM—so your daily routine runs smoothly.'
    },
    {
      id: 'faq2',
      question: 'Do I need to provide food and accommodation?',
      answer: 'No. A full-time maid goes home every evening, so accommodation is not required. Food is also not an obligation, though many families offer lunch or tea as a goodwill gesture.'
    },
    {
      id: 'faq3',
      question: 'What if the maid is late or absent?',
      answer: 'If your maid is repeatedly late or absent without reason, share the issue with us. We will talk to her and fix it, and if needed, arrange a temporary support or a quick replacement so your home work is not disrupted.'
    },
    {
      id: 'faq4',
      question: 'How many leave days does a full-time maid get?',
      answer: 'Most full-time maids take 2–4 paid offs per month, which is the standard practice. The leave days are agreed in advance so you can plan your household routine accordingly.'
    },
    {
      id: 'faq5',
    ...
    {
      id: 'faq6',
      question: 'Can I hire a full-time maid for a short period?',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="pt-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight font-display">
                Hire Verified <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-300 to-success-300">Full-Time Maids</span> in Bareilly
              </h1>
              <p className="text-xl text-primary-100 mb-8 leading-relaxed font-light">
                Background-checked maids for Bareilly families — 8–10 hours of daily housekeeping, cooking & child/elder care. <span className="text-white font-medium">Quick joining in 48-72 hours.</span>
              </p>
            ...
            <div className="relative z-10">
              <AdLeadForm city="Bareilly" trackingEvent="full_time_maid_bareilly_ad" serviceType="full-time" messagePlaceholder="I need a full-time maid for..." />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-display">
              Full-Time Maid Services (8-10 Hours Daily)
            </h2>
      ...
      <section className="py-20 bg-primary-600 text-white text-center relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <h2 className="text-3xl text-white md:text-5xl font-bold mb-6 font-display leading-tight">
            Ready to Hire a Trusted <br />Full-Time Maid?
          </h2>
          <p className="text-xl text-primary-100 mb-10 max-w-2xl mx-auto font-light">
            Join thousands of Bareilly families who trust EzyHelpers for safe, reliable home help.
          </p>
