        ...
        <div className="container-custom relative">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link href="/hire-helper" className="group relative bg-white text-red-800 font-bold text-lg px-10 py-5 rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl">
                <span className="relative z-10">Book Helper in Delhi</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-8 font-display">
                ...
                <span className="block text-pink-200">in Delhi?</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-pink-200 text-sm">Background Checked</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-pink-200 text-sm">Customer Satisfaction</div>
                </div>
              </div>
            </div>
          </div>
