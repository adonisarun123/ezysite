...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Domestic Help in Meerut | Verified Maids & Home Help | EzyHelpers",
    description: "Hire verified domestic help in Meerut for business families, professionals, and educational areas. Maids, cooks, and more via EzyHelpers.",
    url: "https://www.ezyhelpers.com/cities/meerut",
    type: 'website',
    siteName: 'EzyHelpers',
    locale: 'en_IN',
    images: [{ url: "https://www.ezyhelpers.com/og?title=Domestic%20Help%20in%20Meerut", width: 1200, height: 630, alt: "Domestic Help in Meerut" }],
  },
  alternates: {
    canonical: 'https://www.ezyhelpers.com/cities/meerut',
    languages: selfReferencingLanguages('/cities/meerut'),
  },
}
...
export default async function MeerutPage() {
  ...
  return (
    <main className="min-h-screen">
      <LocalBusinessSchema cityName="Meerut" stateName="Uttar Pradesh" postalCode="250001" latitude={28.9845} longitude={77.7064} />
      <Navbar />
      ...
      <section className="section-padding bg-cyan-600 text-white text-center">
        <div className="container-custom">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/hire-helper" className="bg-white text-cyan-600 hover:bg-gray-100 font-bold text-lg px-8 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
              Get Started Today
            </Link>
            <Link href="tel:+918031411776" className="border-2 border-white text-white hover:bg-white hover:text-cyan-600 font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center">
