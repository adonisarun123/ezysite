      ...
      <section className="section-padding bg-cyan-600 text-white text-center">
        <div className="container-custom">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="tel:+919972571005" className="border-2 border-white text-white hover:bg-white hover:text-cyan-600 font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center">
