...
export default async function LucknowPage() {
  const __dbHtml = await getHtmlContent("cities/lucknow")
  if (__dbHtml) return <DbHtmlContent content={__dbHtml} />

  const quickAnswer = await getCityQuickAnswer("cities/lucknow", {
      ...
      />
        ...
        <section className="section-padding bg-amber-600 text-white text-center">
          <div className="container-custom">
            ...
            <Link href="tel:+918031411776" className="border-2 border-white text-white hover:bg-white hover:text-amber-600 font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center">
