...
export default async function BangaloreElectricianPage() {
  const __dbHtml = await getHtmlContent("cities/bangalore/electrician")
  ...
  const breadcrumbs = [
    ...
    { name: 'Electrician', url: 'https://www.ezyhelpers.com/cities/bangalore/electrician' }
  ]
  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <FAQSchema faqs={faqs} aboutPage="https://www.ezyhelpers.com/cities/bangalore/electrician" />
