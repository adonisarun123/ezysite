...
export default async function BangaloreGardenerPage() {
  const __dbHtml = await getHtmlContent("cities/bangalore/gardener")
  ...
  const breadcrumbs = [
    ...
    { name: 'Gardener', url: 'https://www.ezyhelpers.com/cities/bangalore/gardener' }
  ]
  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <FAQSchema faqs={faqs} aboutPage="https://www.ezyhelpers.com/cities/bangalore/gardener" />
