              ...
              {[
                {
                  ...
                  linkText: "Book Travel Nanny"
                },
                {
                  title: "Home Chef",
                  description: "Hire professional Home Chefs in Bangalore for hygienic, menu-based, high-quality everyday home cooking.",
                  features: ["Personalised meal planning", "Indian & multi-cuisine expertise", "Clean, safe & professional cooking"],
                  href: "/cities/bangalore/home-chef",
                  linkText: "Book Home Chef"
                },
                {
                  title: "Chauffeur Service",
                  description: "Professional Chauffeurs in Bangalore who ensure safe, smooth, comfortable driving for luxury cars.",
                  features: ["Verified & background-checked drivers", "Experienced with high-end vehicles", "Safe, courteous & reliable driving"],
                  href: "/cities/bangalore/chauffeur-service",
                  linkText: "Book A Chauffeur"
                },
                {
                  title: "Educated Babysitter",
                  description: "Hire Educated Babysitters in Bangalore for safe, learning-focused childcare with homework support daily.",
                  features: ["Verified babysitters", "Learning & age-appropriate care", "Homework & reading support"],
                  href: "/cities/bangalore/educated-babysitter",
                  linkText: "Book Babysitter Now"
                },
              ].map((service, index) => (
