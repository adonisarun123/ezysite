...
export default async function BangaloreCooksPage() {
  const __dbHtml = await getHtmlContent("cities/bangalore/cooks")
  ...
  const breadcrumbs = [
    ...
    { name: 'Cooks for Home', url: 'https://www.ezyhelpers.com/cities/bangalore/cooks' }
  ]
  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <FAQSchema faqs={faqs} aboutPage="https://www.ezyhelpers.com/cities/bangalore/cooks" />
