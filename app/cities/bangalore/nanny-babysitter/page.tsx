...
export default async function BangaloreNannyBabysitterPage() {
  const __dbHtml = await getHtmlContent("cities/bangalore/nanny-babysitter")
  ...
  const breadcrumbs = [
    ...
    { name: 'Nanny & Babysitter', url: 'https://www.ezyhelpers.com/cities/bangalore/nanny-babysitter' }
  ]
  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <FAQSchema faqs={faqs} aboutPage="https://www.ezyhelpers.com/cities/bangalore/nanny-babysitter" />
      ...
      <CityBlogLinks
        ...
        title="Childcare Guides for Bangalore Parents"
        subtitle="Expert advice on nannies, live-in childcare, and working-parent routines."
      />
