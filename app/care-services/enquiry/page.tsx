      ...
      <header className="bg-white">
        <div className="mx-auto max-w-7xl px-4 pb-10 pt-2 sm:px-6 lg:px-8 lg:pb-14">
          <div className="grid min-h-0 gap-2 overflow-hidden rounded-[28px] border border-neutral-200 bg-neutral-50 shadow-[0_6px_24px_rgba(0,0,0,0.06)] lg:min-h-[420px] lg:grid-cols-2 lg:gap-0">
            <div className="relative flex flex-col justify-between bg-gradient-to-br from-primary-100 to-primary-50 p-8 text-left sm:p-10 lg:p-12">
              <div
                className="pointer-events-none absolute bottom-[-60px] right-[-60px] h-56 w-56 rounded-full bg-primary-500/12 blur-2xl"
                aria-hidden
              />
              <div className="relative">
                ...
                <h1 className="font-careSerif text-[clamp(2.25rem,4.5vw,3.5rem)] font-medium leading-[1.05] tracking-[-0.025em] text-[#222]">
                  ...
                  <br />
                  <em className="font-careSerif font-normal italic text-primary-500">your loved one</em> needs.
                </h1>
            ...
            <div className="grid min-h-[240px] grid-cols-2 grid-rows-2 gap-2 p-2 sm:min-h-[300px] sm:p-3 lg:min-h-0">
              <div className="relative row-span-2 overflow-hidden rounded-2xl bg-gradient-to-br from-primary-400 to-primary-400 shadow-inner">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr] lg:items-start lg:gap-12">
              ...
              <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)] sm:p-10">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary-500">Care enquiry</p>
                <h2 className="mt-3 font-careSerif text-[clamp(1.5rem,3.2vw,2rem)] font-medium leading-tight tracking-tight text-neutral-950">
                  A few details, <em className="font-careSerif font-normal italic text-primary-500">that&apos;s all.</em>
                </h2>
              ...
              <aside className="lg:sticky lg:top-28 lg:self-start">
                <div className="grid gap-5">
                  ...
                  <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-primary-100 via-[#FFC4B0] to-[#FF8A65] p-6 text-neutral-900 shadow-[0_24px_60px_rgba(255,90,60,0.18)] sm:p-7">
                    <div
                    ...
                    <ol className="mt-5 space-y-4">
                      {HOW_IT_WORKS.map((s) => (
                        <li key={s.mark} className="flex items-start gap-3">
                          <span className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-primary-50 font-careSerif text-sm font-semibold uppercase text-primary-500">
                            {s.mark}
                          </span>
                  ...
                  {/* Need help choosing */}
                  <div className="rounded-[24px] border border-neutral-200 bg-primary-50 p-6 sm:p-7">
                    <div className="flex items-center gap-2">
                      <SparklesIcon className="h-4 w-4 text-primary-500" aria-hidden />
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary-500">Not sure yet?</p>
                    </div>
                    <h3 className="mt-2 font-careSerif text-xl font-semibold tracking-tight text-neutral-950">
                      Need help choosing?
                    </h3>
