...
export const metadata: Metadata = {
  title: 'Electrician Services in India | Wiring & Repairs',
  description: 'Book a certified electrician anywhere in India for wiring, repairs & installations. Emergency service available. Fast, reliable, and background-verified.',
...
export default async function ElectriciansPage() {
  ...
  const breadcrumbs = [
    ...
    { name: "Electricians", url: "https://www.ezyhelpers.com/services/electricians" }
  ]
  ...
  return (
    <>
      <ServiceSchema serviceName={"Expert Electrician Services for Your Home"} serviceDescription={"Book a certified electrician anywhere in India for wiring, repairs & installations. Emergency service available. Fast, reliable, and background-verified."} serviceType={"Expert Electrician Services for Your Home"} serviceUrl={"https://www.ezyhelpers.com/services/electricians"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "How can I find electrician services near me?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Browse the city list above to find electrician services available in your location. Each city page contains information about electrical services, local availability, and booking options."
              }
            }]
          })
        }}
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-bold mb-6 font-display leading-tight">
                Electrician Service Across India: Wiring, Repairs & Installations
              </h1>

              <p className="text-xl lg:text-2xl text-blue-100 mb-10 leading-relaxed max-w-3xl mx-auto">
                EzyHelpers connects you with certified, verified electricians across India for wiring, repairs, lighting installation, and appliance installation.
              </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Browse available cities to hire electricians for residential electrical work.
              </p>
            </div>
