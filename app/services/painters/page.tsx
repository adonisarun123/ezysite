...
export const metadata: Metadata = {
  title: 'House Painting in India | Interior & Exterior | EzyHelpers',
  description: 'Book professional house painters anywhere in India for interior & exterior walls. Get quality painting services, affordable rates and easy booking.',
...
export default async function PaintersPage() {
  ...
  return (
    <>
      <ServiceSchema serviceName={"House Painting Services"} serviceDescription={"Book professional house painters anywhere in India for interior & exterior walls. Get quality painting services, affordable rates and easy booking."} serviceType={"House Painting Services"} serviceUrl={"https://www.ezyhelpers.com/services/painters"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "How do I check if house painting is available in my city?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Choose your city from the list above to explore painting services available in your area. City pages include location-specific information such as service availability, quotations, and local support."
              }
            }, {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Our painters handle interior walls, exterior surfaces, texture work, and complete home repainting. Visit your city page or call us for a quote based on your home size."
              }
            }]
          })
        }}
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-bold mb-6 font-display leading-tight">
                House Painting Service Across India: Interior & Exterior Painting
              </h1>

              <p className="text-xl lg:text-2xl text-purple-100 mb-10 leading-relaxed max-w-3xl mx-auto">
                Refresh your home with professional house painting services in India. Hire experienced painters for interior walls, exterior surfaces, texture finishes, and complete home repainting.
              </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-display">
                Painting Services in Available Cities
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Browse the cities below to find experienced painters for interior and exterior painting projects.
              </p>
            </div>
