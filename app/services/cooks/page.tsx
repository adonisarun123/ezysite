            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                  <Link href="/hire-helper" className="group relative bg-white text-orange-800 hover:bg-orange-50 font-bold text-lg px-8 py-4 rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
                    <span className="relative z-10">Hire Professional Cook</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-white to-orange-50 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  </Link>
