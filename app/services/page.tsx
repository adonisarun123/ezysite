  ...
  const premiumServices: ServiceItem[] = [
    {
      ...
      href: "/premium-chauffeur-service",
      icon: TruckIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Experienced luxury car drivers", "Professional, verified drivers", "Help for short and long trips"],
      ctaText: "Book Chauffeur Now"
    }, {
      title: "Professional Chef",
      description: "Book Professional Chefs at home for daily meals, healthy diets, and special occasions.",
      href: "/professional-chef-for-home",
      icon: FireIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Gourmet meals at home", "Skilled and verified chefs", "Personalised food planning"],
      ctaText: "Book Home Chef"
    }, {
      title: "Japa Nanny",
      description: "Book trained Japa Nannies for newborn care and mother recovery support.",
      href: "/japa-nanny-services",
      icon: SparklesIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Newborn care at home", "Mother's recovery support", "Post-delivery help"],
      ctaText: "Book Japa Nanny"
    }, {
      ...
      href: "/english-speaking-babysitters",
      icon: AcademicCapIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["English learning support", "Safe child handling", "Polite and trained care"],
      ctaText: "Book Babysitter Now"
    }, {
      title: "Patient Care Services",
      description: "Get compassionate Patient Care at home for daily support, comfort, and safety.",
      href: "/patient-care-services-at-home",
      icon: HeartIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Daily care and assistance", "Kind, patient helpers", "Post-surgery recovery"],
      ctaText: "Book Caregiver Now"
    }, {
      ...
      href: "/special-needs-caregiver",
      icon: UserGroupIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Gentle daily care", "Safe home support", "Routine assistance"],
      ctaText: "Book Caregiver Now"
    }, {
      title: "Dog Pet Sitters",
      description: "Find trusted Dog Pet Sitters for daily care and home support.",
      href: "/dog-pet-sitters",
      icon: HomeIcon,
      bgColor: "bg-amber-50",
      iconColor: "text-amber-600",
      borderColor: "border-amber-200",
      features: ["Feeding and walking help", "Clean and safe care", "Reliable pet support"],
      ctaText: "Book Dog Sitter"
    }
  ]
  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <section className="relative section-padding bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-200 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-200 rounded-full blur-3xl transform -translate-x-1/2 translate-y-1/2"></div>
          </div>

          <div className="container-custom relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center bg-amber-100 text-amber-800 rounded-full px-4 py-2 mb-6 shadow-sm border border-amber-200">
                <StarIcon className="h-4 w-4 mr-2" />
                <span className="text-sm font-semibold">Exclusive Premium Offerings</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-display">
                Premium Services
              </h2>
              <p className="text-lg text-gray-600 max-w-4xl mx-auto">
                Experience the height of luxury and convenience with our top-tier specialized services designed for your complete comfort
              </p>
            </div>
              ...
              {premiumServices.map((service, index) => {
                ...
                return (
                  <Link
                    key={index}
                    href={service.href}
                    className="group relative bg-gradient-to-br from-yellow-50 to-amber-100 hover:bg-gradient-to-br hover:from-gray-800 hover:to-gray-900 rounded-2xl p-7 border border-amber-200 hover:border-transparent shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer overflow-hidden flex flex-col"
                  >
                    <div className="relative z-10 flex-grow">
                      {/* Premium Badge */}
                      <div className="absolute top-0 right-0">
                        <div className="bg-gradient-to-r from-amber-400 to-yellow-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm uppercase tracking-wider">
                          Premium
                        </div>
                      </div>

                      {/* Icon */}
                      <div className="w-16 h-16 bg-gradient-to-br from-amber-100 to-yellow-200 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300 border border-amber-200 group-hover:border-amber-300 shadow-inner">
                        <IconComponent className="h-8 w-8 text-amber-600 group-hover:text-amber-700 transition-all duration-300 drop-shadow-sm" />
                      </div>

                      {/* Content */}
                      <h3 className="text-xl font-bold text-gray-900 mb-3 font-display transition-colors duration-300 group-hover:text-white min-h-[3.5rem] flex items-center">
                        {service.title}
                      </h3>
                      <p className="text-gray-600 mb-6 leading-relaxed transition-colors duration-300 text-sm group-hover:text-white/90 min-h-[5rem]">
                        {service.description}
                      </p>
                      ...
                      <div className="space-y-3 mb-8">
                        {service.features.map((feature, idx) => (
                          <div key={idx} className="flex items-start text-sm">
                            <CheckCircleIcon className="h-5 w-5 text-amber-500 mr-3 transition-colors duration-300 shrink-0 mt-0.5 group-hover:text-white" />
                            <span className="text-gray-700 font-medium group-hover:text-white/90">{feature}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* CTA */}
                    <div className="flex items-center justify-between mt-auto pt-5 border-t border-gray-100 group-hover:border-gray-700 transition-colors">
                      <span className="text-amber-600 font-bold text-sm transition-colors duration-300 uppercase tracking-wide group-hover:text-white">
                        {service.ctaText}
                      </span>
                      <div className="w-8 h-8 rounded-full bg-amber-50 group-hover:bg-white/20 flex items-center justify-center transition-all duration-300">
                        <ArrowRightIcon className="h-4 w-4 text-amber-600 group-hover:text-white group-hover:translate-x-0.5 transition-all duration-300" />
                      </div>
                    </div>
                  </Link>
                )
