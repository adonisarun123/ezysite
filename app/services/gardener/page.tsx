...
export const metadata: Metadata = {
  title: 'Gardener Services in India | Lawn & Plant Care | EzyHelpers',
  description: 'Book a professional gardener anywhere in India for lawn care, plant maintenance & landscaping. Experienced gardeners for homes, apartments, and gardens.',
...
export default function GardenerPage() {
  ...
  const breadcrumbs = [
    ...
    { name: "Gardener", url: "https://www.ezyhelpers.com/services/gardener" }
  ]
  ...
  return (
    <>
      <ServiceSchema serviceName={"Home Gardener Services"} serviceDescription={"Book a professional gardener anywhere in India for lawn care, plant maintenance & landscaping. Experienced gardeners for homes, apartments, and gardens."} serviceType={"Home Gardener Services"} serviceUrl={"https://www.ezyhelpers.com/services/gardener"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "Where are gardener services currently available?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Gardener services are offered in selected cities across India. Your city page provides details about local availability, supported gardening services, and booking information for your area."
              }
            }, {
              "@type": "Question",
              "name": "Can I hire a gardener for a one-time visit or only on a regular basis?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Both options are available. You can book a one-time gardener visit or set up a recurring weekly or monthly arrangement. Visit your city page or call us to discuss your garden's needs."
              }
            }]
          })
        }}
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-bold mb-6 font-display leading-tight">
                Gardener Service Across India: Lawn Care, Plant Maintenance & Landscaping
              </h1>

              <p className="text-xl lg:text-2xl text-green-100 mb-10 leading-relaxed max-w-3xl mx-auto">
                Maintain a healthy and beautiful garden with professional gardener services in India for lawn care, plant maintenance, pruning, landscaping, and terrace gardens.
              </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-display">
                Gardening Services by Location
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Select your city to discover gardener services for homes, villas, apartments, and outdoor spaces.
              </p>
            </div>
