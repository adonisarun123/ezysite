...
export const metadata: Metadata = {
  title: 'Nanny & Babysitter in India | Experienced Caregivers',
  description: 'Hire an experienced babysitter or nanny in India. Background-verified, trained in child safety. Daily & full-time childcare across multiple cities in India.',
...
export default function NannyBabysitterPage() {
  ...
  return (
    <>
      <ServiceSchema serviceName={"Professional Babysitter Services"} serviceDescription={"Hire an experienced babysitter or nanny in India. Background-verified, trained in child safety. Daily & full-time childcare across multiple cities in India."} serviceType={"Professional Babysitter Services"} serviceUrl={"https://www.ezyhelpers.com/services/nanny-babysitter"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "Is babysitter and nanny service available across India?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Childcare services are available in selected cities across India. Choose your city to explore available nanny and babysitter options, caregiver roles, and local booking information."
              }
            }, {
              "@type": "Question",
              "name": "What is the difference between a babysitter and a nanny?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "A babysitter usually provides childcare for a few hours or on specific days, while a nanny offers regular or full-time support and may assist with the child's daily routine. The services available may vary depending on your city."
              }
            }]
          })
        }}
      ...
      <main className="min-h-screen">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-display leading-tight text-white drop-shadow-lg">
                    Babysitter & Nanny Service Across India: Experienced Child Care
                  </h1>

                  <p className="text-xl lg:text-2xl text-white/95 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 drop-shadow-sm">
                    Looking for a babysitter in India? Find experienced childcare professionals for infants, toddlers, after-school care, and full-time nanny support based on your family's needs.
                  </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Find experienced nannies and babysitters in the cities listed below.
              </p>
            </div>
        ...
        <NestCTA />
        <AvailableInCities
          serviceSlug="nanny-babysitter"
          serviceName="Nanny & Babysitter"
          cities={[
            { name: "Bangalore", href: "/cities/bangalore/nanny-babysitter" },
            { name: "Bareilly", href: "/cities/bareilly/babysitter" },
          ]}
