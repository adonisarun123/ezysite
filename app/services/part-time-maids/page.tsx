...
export const metadata: Metadata = {
  title: 'Part-Time Maid in India | Flexible Daily Help',
  description: 'Hire a verified part-time maid anywhere in India for 2 to 6 hours of daily help. Cleaning, cooking & more. Trusted by professionals across multiple cities.',
...
export default async function PartTimeMaidsPage() {
  ...
  return (
    <>
      <ServiceSchema serviceName={"Part-Time Maid Services"} serviceDescription={"Hire a verified part-time maid anywhere in India for 2 to 6 hours of daily help. Cleaning, cooking & more. Trusted by professionals across multiple cities."} serviceType={"Part-Time Maid Services"} serviceUrl={"https://www.ezyhelpers.com/services/part-time-maids"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "Is part-time maid service available in cities other than Bangalore?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Part-time maid services are available in selected cities across India. Visit your city's page to learn about local working hours, available services, salary expectations, and booking options."
              }
            }]
          })
        }}
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-display leading-tight text-white drop-shadow-lg">
                    Part-Time Maid Service Across India:  Flexible Daily Home Help
                  </h1>

                  <p className="text-xl lg:text-2xl text-white/95 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 drop-shadow-sm">
                    Part-time maid services in India are designed for households that need help for a few hours each day. Whether you need assistance with cleaning, utensils, laundry, or cooking, you can choose schedules that match your daily routine.
                  </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                EzyHelpers provides verified part-time maids across major cities in India.
              </p>
            </div>
