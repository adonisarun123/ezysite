...
export const metadata: Metadata = {
  title: 'Elderly Care in India | Trusted Senior Help | EzyHelpers',
  description: 'Compassionate elderly care helpers across India. Trained for companionship, medication reminders & mobility support. Serving Bangalore, Bareilly & more.',
...
export default function ElderlyCare() {
  ...
  return (
    <>
      <ServiceSchema serviceName={"Compassionate Elderly Care Services for Seniors"} serviceDescription={"Compassionate elderly care helpers across India. Trained for companionship, medication reminders & mobility support. Serving Bangalore, Bareilly & more."} serviceType={"Compassionate Elderly Care Services for Seniors"} serviceUrl={"https://www.ezyhelpers.com/services/elderly-care"} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [{
              ...
              "@type": "Question",
              "name": "How do I check elderly care availability in my area?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Elderly care services are available in selected Indian cities. Visit your city's page to explore caregiver options, supported services, and booking details available for your location."
              }
            }]
          })
        }}
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-display leading-tight text-white drop-shadow-lg">
                    Elderly Care Service Across India: Compassionate Senior Home Help
                  </h1>

                  <p className="text-xl lg:text-2xl text-white/95 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 drop-shadow-sm">
                    Find professional elder care services in India for companionship, mobility assistance, daily support, and senior caregiving. Choose the right care solution based on your needs.
                  </p>
          ...
          <div className="container-custom relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Elderly care services are available in the cities listed below.
              </p>
            </div>
