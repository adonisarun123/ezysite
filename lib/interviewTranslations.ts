...
export const translations: Record<Language, any> = {
    en: {
        ...
        fields: {
            ...
            foodAllergies: 'Do you have any food allergies? (e.g., Peanuts, Milk, Egg)',
    ...
    hi: {
        ...
        fields: {
            ...
            comfortableCooking: 'क्या आप खाना बनाने में ठीक हैं?',
            ...
            earlyStart: 'क्या आप सुबह जल्दी काम शुरू करने में ठीक हैं?',
            comfortablePets: 'क्या आप पालतू जानवरों, विशेषकर कुत्तों के साथ ठीक हैं?',
            ...
            menstrualCycleComfort: 'क्या आप माहवारी के दौरान काम करने में ठीक हैं? (वैकल्पिक)',
            riceOrRoti: 'क्या आप चावल या रोटी के साथ ठीक हैं?',
            howManyRotis: 'आप नियमित रूप से कितनी रोटियाँ खाते हैं?',
            vegNonVegPreference: 'क्या आप घर के अनुसार शाकाहारी या मांసాहारी भोजन खाने में ठीक हैं?',
            foodRestrictions: 'क्या आपको किसी प्रकार की भोजन संबंधी पाबंदी है?',
            foodAllergies: 'क्या आपको किसी भोजन से एलर्जी है? (जैसे: मूँगफली, दूध, अंडा)',
    ...
    kn: {
        ...
        fields: {
            ...
            foodAllergies: 'ನಿಮಗೆ ಯಾವುದೇ ಆಹಾರದ ಅಲರ್ಜಿ ಇದೆಯೆ? (ಉದಾ: ಶೇಂಗಾ, ಹಾಲು, ಮೊಟ್ಟೆ)',
    ...
    ta: {
        ...
        fields: {
            ...
            foodAllergies: 'உங்களுக்கு ஏதேனும் உணவு ஒவ்வாமை (Food Allergy) உள்ளதா? (உதாரணம்: வேர்க்கடலை, பால், முட்டை)',
    ...
    te: {
        ...
        fields: {
            ...
            foodAllergies: 'మీకు ఏదైనా ఆహార అలర్జీ ఉందా? (ఉదాహరణకు: వేరుశనగ, పాలు, గుడ్డు)',
