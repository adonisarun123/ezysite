    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}">${safe(formData.email)}</a></p>
          <p><strong>Phone:</strong> <a href="tel:${safe(formData.phone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPhone)}</a></p>
          <p><strong>Subject:</strong> ${safe(formData.subject)}</p>
        </div>
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
          <h3 style="margin-top: 0; color: #333;">Message</h3>
          <p style="white-space: pre-wrap;">${safe(formData.message)}</p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}">${safe(formData.email)}</a></p>
          <p><strong>Phone:</strong> <a href="tel:${safe(formData.phone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPhone)}</a></p>
          <p><strong>City:</strong> ${safe(formData.city)}</p>
          <p><strong>Locality:</strong> ${safe(formData.locality?.trim() || '—')}</p>
          <p><strong>Apartment:</strong> ${safe(formData.apartment?.trim() || '—')}</p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Name:</strong> ${safe(formData.name)}</p>
          <p><strong>Phone:</strong> <a href="tel:${safe(formData.phone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPhone)}</a></p>
          ${formData.email ? `<p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}">${safe(formData.email)}</a></p>` : ''}
          ${formData.additionalDetails?.field_officer_name ? `<p><strong>Field Officer Name:</strong> ${safe(formData.additionalDetails.field_officer_name)}</p>` : ''}
          <p><strong>Service:</strong> ${safe(formData.service)}</p>
          <p><strong>City:</strong> ${safe(formData.city)}</p>
        </div>
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #333;">📋 Service Requirements</h3>
          ${formData.additionalDetails.duration ? `<p><strong>Duration:</strong> ${safe(formData.additionalDetails.duration)}</p>` : ''}
          ${formData.additionalDetails.startDate ? `<p><strong>Preferred Start Date:</strong> ${safe(formData.additionalDetails.startDate)}</p>` : ''}
          ${formData.additionalDetails.budget ? `<p><strong>Monthly Budget:</strong> ₹${safe(formData.additionalDetails.budget)}</p>` : ''}
          ${formData.additionalDetails.familySize ? `<p><strong>Family Size:</strong> ${safe(formData.additionalDetails.familySize)}</p>` : ''}
        </div>
        
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #333;">👤 Helper Preferences</h3>
          ${formData.additionalDetails.experience ? `<p><strong>Experience Level:</strong> ${safe(formData.additionalDetails.experience)}</p>` : ''}
          ${formData.additionalDetails.preferredGender ? `<p><strong>Gender Preference:</strong> ${safe(formData.additionalDetails.preferredGender)}</p>` : ''}
          ${formData.additionalDetails.languages ? `<p><strong>Preferred Languages:</strong> ${safe(formData.additionalDetails.languages)}</p>` : ''}
          ${formData.additionalDetails.additionalServices ? `<p><strong>Additional Services:</strong> ${safe(formData.additionalDetails.additionalServices)}</p>` : ''}
        </div>
        
        ${formData.additionalDetails.specificRequirements ? `
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #333;">📝 Specific Requirements</h3>
          <p style="white-space: pre-wrap;">${safe(formData.additionalDetails.specificRequirements)}</p>
        </div>
        ` : ''}
        ` : isHelperLead ? `
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #333;">👷‍♀️ Helper Registration Details</h3>
          <p><strong>Services You Can Provide:</strong> ${safe(formatServices(formData.additionalDetails.job_roles))}</p>
          ${formData.additionalDetails.job_role_other ? `<p><strong>Other Service:</strong> ${safe(formData.additionalDetails.job_role_other)}</p>` : ''}
          ${formData.additionalDetails.area_of_residence ? `<p><strong>Area of Residence:</strong> ${safe(formData.additionalDetails.area_of_residence)}</p>` : ''}
          ${Array.isArray(formData.additionalDetails.languages) && formData.additionalDetails.languages.length ? `<p><strong>Languages:</strong> ${safe(formData.additionalDetails.languages.join(', '))}</p>` : ''}
          ${formData.additionalDetails.remarks ? `<p><strong>Additional Info:</strong> ${safe(formData.additionalDetails.remarks)}</p>` : ''}
        </div>
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
          ...
          ${formData.additionalDetails.detected_city || formData.additionalDetails.detected_region || formData.additionalDetails.detected_country ? `
            <p><strong>Detected Location:</strong> ${safe([
          ...
          ${(formData.additionalDetails.latitude && formData.additionalDetails.longitude) ? `
            <p><strong>Coordinates:</strong> ${safe(formatCoordinatesForEmail(formData.additionalDetails.latitude, formData.additionalDetails.longitude))}</p>
            <p><strong>Maps Link:</strong> <a href="https://www.google.com/maps?q=${safe(formData.additionalDetails.latitude)},${safe(formData.additionalDetails.longitude)}" target="_blank" style="color: #1e40af; text-decoration: underline;">View on Google Maps</a></p>
          ` : ''}
        </div>
        ` : ``}
        ` : ''}
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #334155;">Registration ID: ${safe(formData.id)}</h3>
          <p><strong>Registration Date:</strong> ${safe(new Date().toLocaleString())}</p>
          <p><strong>Listed By:</strong> ${safe(formData.listedBy || 'Self Registration')}</p>
        </div>
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Agency Name:</strong> ${safe(formData.agencyName)}</p>
          <p><strong>Registration Number:</strong> ${safe(formData.registrationNumber)}</p>
          <p><strong>Year Founded:</strong> ${safe(formData.yearFounded)}</p>
          <p><strong>Services Offered:</strong> ${safe(formData.servicesOffered.join(', '))}</p>
          <p><strong>Max Helpers Supply:</strong> ${safe(formData.maxHelpersSupply)} helpers per month</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Owner Details</h3>
          <p><strong>Owner Name:</strong> ${safe(formData.ownerName)}</p>
          <p><strong>Date of Birth:</strong> ${safe(formData.ownerDOB)}</p>
          <p><strong>ID Type:</strong> ${safe(formData.ownerIDType)}</p>
          <p><strong>ID Number:</strong> ${safe(formattedIDNumber)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Contact Information</h3>
          <p><strong>Primary Phone:</strong> <a href="tel:${safe(formData.primaryPhone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPrimaryPhone)}</a></p>
          ${formData.secondaryPhone ? `<p><strong>Secondary Phone:</strong> <a href="tel:${safe(formData.secondaryPhone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedSecondaryPhone)}</a></p>` : ''}
          <p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}">${safe(formData.email)}</a></p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Office Address</h3>
          <p><strong>Address Line 1:</strong> ${safe(formData.officeAddressLine1)}</p>
          ${formData.officeAddressLine2 ? `<p><strong>Address Line 2:</strong> ${safe(formData.officeAddressLine2)}</p>` : ''}
          <p><strong>City:</strong> ${safe(formData.city)}</p>
          <p><strong>State:</strong> ${safe(formData.state)}</p>
          <p><strong>Pincode:</strong> ${safe(formData.pincode)}</p>
          ${formattedCoordinates ? `<p><strong>Coordinates:</strong> ${safe(formattedCoordinates)}</p>` : ''}
        </div>
        ...
        <div style="background-color: #fffbeb; padding: 20px; border: 1px solid #fbbf24; border-radius: 8px; margin: 20px 0;">
          ...
          <p style="white-space: pre-wrap;">${safe(formData.notes)}</p>
        </div>
        ` : ''}
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Registration Date:</strong> ${safe(new Date().toLocaleString())}</p>
          <p><strong>Listed By:</strong> ${safe(formData.listedBy || 'Self Registration')}</p>
          <p><strong>Helper Type:</strong> <span style="background-color: #dbeafe; color: #1e40af; padding: 4px 8px; border-radius: 4px; font-weight: bold;">${safe(formData.helperType)}</span></p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Personal Information</h3>
          <p><strong>Name:</strong> ${safe(formData.firstName)} ${safe(formData.lastName || '')}</p>
          <p><strong>Gender:</strong> ${safe(formData.gender)}</p>
          <p><strong>Date of Birth:</strong> ${safe(formData.dateOfBirth)} (Age: ${safe(formData.age)} years)</p>
          <p><strong>Native State:</strong> ${safe(formData.nativeState)}</p>
          <p><strong>Current Locality:</strong> ${safe(formData.currentLocality)}</p>
          <p><strong>Languages Known:</strong> ${safe(formData.languagesKnown.join(', '))}</p>
          <p><strong>Education Level:</strong> ${safe(formData.educationLevel)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Family & Personal Details</h3>
          <p><strong>Marital Status:</strong> ${safe(formData.maritalStatus)}</p>
          ${formData.spouseOccupation ? `<p><strong>Spouse Occupation:</strong> ${safe(formData.spouseOccupation)}</p>` : ''}
          <p><strong>Number of Kids:</strong> ${safe(formData.kidsCount)}</p>
          ...
          <p><strong>Vaccination Status:</strong> ${safe(formData.vaccinationStatus)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Work Experience & Skills</h3>
          <p><strong>Experience:</strong> ${safe(formData.experienceMonths)} months</p>
          <p><strong>Specialities:</strong> ${safe(formData.specialities.join(', '))}</p>
          <p><strong>Working Hours Preference:</strong> ${safe(formData.workingHoursPreference)}</p>
          ${formData.preferredLocalities ? `<p><strong>Preferred Localities:</strong> ${safe(formData.preferredLocalities)}</p>` : ''}
          <p><strong>Max Placements Per Month:</strong> ${safe(formData.maxPlacementsPerMonth)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Salary Expectations</h3>
          <p><strong>Expected Salary Range:</strong> ₹${safe(formData.expectedSalaryMin)} - ₹${safe(formData.expectedSalaryMax)} per month</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Identity Verification</h3>
          <p><strong>ID Proof Type:</strong> ${safe(formData.idProofType)}</p>
          <p><strong>ID Proof Number:</strong> ${safe(formattedIDNumber)}</p>
        </div>

        ${formData.bankName || formData.accountNumber ? `
        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Banking Details</h3>
          ${formData.bankName ? `<p><strong>Bank Name:</strong> ${safe(formData.bankName)}</p>` : ''}
          ${formData.bankIFSC ? `<p><strong>IFSC Code:</strong> ${safe(formData.bankIFSC)}</p>` : ''}
          ${formData.accountHolderName ? `<p><strong>Account Holder Name:</strong> ${safe(formData.accountHolderName)}</p>` : ''}
          ${formData.accountNumber ? `<p><strong>Account Number:</strong> ${safe(formattedAccountNumber)}</p>` : ''}
        </div>
        ` : ''}
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Contact Information</h3>
          <p><strong>Primary Phone:</strong> <a href="tel:${safe(formData.primaryPhone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPrimaryPhone)}</a></p>
          ${formData.alternatePhone ? `<p><strong>Alternate Phone:</strong> <a href="tel:${safe(formData.alternatePhone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedAlternatePhone)}</a></p>` : ''}
          ${formData.emergencyContactName ? `<p><strong>Emergency Contact:</strong> ${safe(formData.emergencyContactName)}</p>` : ''}
          ${formData.emergencyContactPhone ? `<p><strong>Emergency Contact Phone:</strong> <a href="tel:${safe(formData.emergencyContactPhone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedEmergencyPhone)}</a></p>` : ''}
          ${formattedCoordinates ? `<p><strong>Location Coordinates:</strong> ${safe(formattedCoordinates)}</p>` : ''}
        </div>

        ${formData.internalNotes ? `
        <div style="background-color: #fffbeb; padding: 20px; border: 1px solid #fbbf24; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #92400e;">Internal Notes</h3>
          <p style="white-space: pre-wrap;">${safe(formData.internalNotes)}</p>
        </div>
        ` : ''}
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Request ID:</strong> <span style="font-family: monospace; background-color: #e1e8f0; padding: 2px 6px; border-radius: 4px;">${safe(formData.requestId)}</span></p>
          <p><strong>Submission Time:</strong> ${safe(new Date(formData.timestamp).toLocaleString())}</p>
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Name:</strong> ${safe(formData.name)}</p>
          <p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}" style="color: #0074C8;">${safe(formData.email)}</a></p>
          <p><strong>Contact Number:</strong> <a href="tel:${safe(formData.contactNo)}" style="color: #1e40af; text-decoration: none;">${safe(formattedContactNo)}</a></p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">📍 Location Details</h3>
          <p><strong>Area of Service:</strong> ${safe(formData.areaOfService)}</p>
          <p><strong>Apartment/Building:</strong> ${safe(formData.apartment)}</p>
          ${formData.address ? `<p><strong>Detected Address:</strong> ${safe(formData.address)}</p>` : ''}
          ${formattedCoordinates ? `
          <p><strong>Coordinates:</strong> ${safe(formattedCoordinates)}</p>
          <p><strong>Maps Link:</strong> <a href="https://www.google.com/maps?q=${safe(formData.latitude)},${safe(formData.longitude)}" target="_blank" style="color: #0074C8;">View on Google Maps</a></p>
          ` : ''}
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">📝 Service Requirements</h3>
          <div style="background-color: #f8fafc; padding: 15px; border-radius: 6px; white-space: pre-wrap; font-family: Arial, sans-serif; line-height: 1.6;">${safe(formData.requirementDescription)}</div>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Name:</strong> ${safe(formData.customerName)}</p>
          <p><strong>Phone:</strong> <a href="tel:${safe(formData.mobileNumber)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPhone)}</a></p>
          <p><strong>Address:</strong> ${safe(formData.houseNumber)}, ${safe(formData.apartmentName)}, ${safe(formData.areaLocality)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Service Requirements</h3>
          <p><strong>Service Type:</strong> ${safe(formData.serviceType)}${formData.serviceType === 'other' ? ` (${safe(formData.serviceTypeOther)})` : ''}</p>
          <p><strong>Work Type:</strong> ${safe(formData.workType)}</p>
          <p><strong>Timings:</strong> ${safe(formData.workTiming.startTime)} - ${safe(formData.workTiming.endTime)}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Preferences</h3>
          <p><strong>Age Preference:</strong> ${safe(formData.agePreference?.replace('_', ' ') || 'No preference')}</p>
          <p><strong>Gender Preference:</strong> ${safe(formData.preferredGender || 'No preference')}</p>
          <p><strong>Languages:</strong> ${safe(formData.languages?.join(', ') || 'No preference')}</p>
          <p><strong>House Rules:</strong> ${safe(formData.houseRules || 'None')}</p>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1e293b;">Daily Routine & Household</h3>
          <p><strong>Wake Up Early:</strong> ${formData.wakeUpEarly ? `Yes (at ${safe(formData.wakeupTime || 'Not specified')})` : 'No'}</p>
          <p><strong>Sleeping Time:</strong> ${safe(formData.usualSleepingTime || 'Not specified')}</p>
          <p><strong>Rest Time:</strong> ${formData.restTimeProvided ? `Yes (${safe(formData.restTimeDetails)})` : 'No'}</p>
          ...
          <p><strong>Food Arrangement:</strong> ${safe(formData.foodArrangement || 'Not specified')}</p>
          <p><strong>Personal Care Provided:</strong> ${safe(formData.personalCareItems?.join(', ') || 'None')}</p>
          <p><strong>Tasks:</strong> ${safe(tasksList)}</p>
          <p><strong>Gas Stove:</strong> ${safe(formData.gasStoveType || 'Not specified')}</p>
          <p><strong>Drop Children:</strong> ${formData.dropChildrenBusStop ? 'Yes' : 'No'}</p>
          <p><strong>House Details:</strong> Pets: ${formData.hasPets ? 'Yes' : 'No'}, Elderly: ${formData.hasElderly ? 'Yes' : 'No'}, Type: ${safe(formData.houseType || 'Not specified')}</p>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; line-height: 1.6; color: #333;">
        ...
        <div style="background-color: #f8fafc; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #e2e8f0;">
          <p style="margin: 0;"><strong>Submission ID:</strong> ${safe(formData.requestId)}</p>
          <p style="margin: 5px 0 0 0;"><strong>Language Used:</strong> ${safe(formData.language.toUpperCase())}</p>
          <p style="margin: 5px 0 0 0;"><strong>Submitted On:</strong> ${safe(new Date(formData.submittedAt).toLocaleString())}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">1. Basic Information</h3>
          <p><strong>Full Name:</strong> ${safe(formData.fullName)}</p>
          <p><strong>Age:</strong> ${safe(formData.age)}</p>
          <p><strong>Marital Status:</strong> ${safe(formData.maritalStatus)}</p>
          <p><strong>Has Children:</strong> ${safe(formData.hasChildren)}</p>
          <p><strong>Local Reference:</strong> ${safe(formData.localReference)}</p>
          <p><strong>Has Smartphone:</strong> ${safe(formData.hasSmartphone)}</p>
          <p><strong>Speak Hindi:</strong> ${safe(formData.speakHindi)}</p>
          <p><strong>Speak/Other Languages:</strong> ${safe(formData.speakOtherLanguages)}</p>
          <p><strong>Read/Write Hindi:</strong> ${safe(formData.readWriteHindi)}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">2. Work Preferences</h3>
          <p><strong>Interests:</strong> ${safe(formData.workInterests.join(', '))}</p>
          <p><strong>Cooking Comfort:</strong> ${safe(formData.comfortableCooking)}</p>
          <p><strong>Cook Type:</strong> ${safe(formData.cookType)}</p>
          <p><strong>Millet/Dietary Meals:</strong> ${safe(formData.prepareMilletDietary)}</p>
          <p><strong>Housekeeping Comfort:</strong> ${safe(formData.comfortableHousekeeping)}</p>
          <p><strong>Clean Bathrooms:</strong> ${safe(formData.willingCleanBathrooms)}</p>
          <p><strong>Ironing:</strong> ${safe(formData.knowIroning)}</p>
          <p><strong>Washing Machine:</strong> ${safe(formData.operateWashingMachine)}</p>
          <p><strong>Appliances:</strong> ${safe(formData.useAppliances)}</p>
          <p><strong>Children Care:</strong> ${safe(formData.comfortableKids)}</p>
          <p><strong>Elderly Care:</strong> ${safe(formData.comfortableElderly)}</p>
          <p><strong>Drop Children at Bus Stop:</strong> ${safe(formData.dropChildrenBusStop)}</p>
          <p><strong>Driving Skills:</strong> ${safe(formData.canDrive)}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">3. Work Habits & Discipline</h3>
          <p><strong>Wake up time:</strong> ${safe(formData.wakeUpTime)}</p>
          <p><strong>Early start:</strong> ${safe(formData.earlyStart)}</p>
          <p><strong>With pets:</strong> ${safe(formData.comfortablePets)}</p>
          <p><strong>Non-veg home:</strong> ${safe(formData.nonVegHome)}</p>
          <p><strong>Phone during work:</strong> ${safe(formData.phoneDuringWork)}</p>
          <p><strong>Social media during work:</strong> ${safe(formData.socialMediaWork)}</p>
          <p><strong>Multiple tasks:</strong> ${safe(formData.manageMultipleTasks)}</p>
          <p><strong>Running behind children:</strong> ${safe(formData.runBehindChildren)}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">4. Health & Leave Policy</h3>
          <p><strong>Regular medicines:</strong> ${safe(formData.regularMedicines)}</p>
          <p><strong>Health conditions:</strong> ${safe(formData.healthConditions)}</p>
          <p><strong>Monthly leave:</strong> ${safe(formData.monthlyLeave)}</p>
          <p><strong>Leave preference:</strong> ${safe(formData.leavePreference)}</p>
          <p><strong>Rest time:</strong> ${safe(formData.restTimeNeeded)}</p>
          <p><strong>Menstrual cycle comfort:</strong> ${safe(formData.menstrualCycleComfort)}</p>
        </div>
        ...
        <div style="margin-bottom: 25px;">
          ...
          <p><strong>Eat same food:</strong> ${safe(formData.eatSameFood)}</p>
          <p><strong>Veg/Non-veg based on household:</strong> ${safe(formData.vegNonVegPreference)}</p>
          <p><strong>Food restrictions:</strong> ${safe(formData.foodRestrictions)}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">6. Training & Skills</h3>
          <p><strong>Formal training:</strong> ${safe(formData.formalTraining)}</p>
          <p><strong>Specific training needs:</strong> ${safe(formData.specificTrainingNeeded)}</p>
          <p><strong>Open to training:</strong> ${safe(formData.openToTraining)}</p>
        </div>

        <div style="margin-bottom: 25px;">
          <h3 style="color: #1e40af; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-bottom: 15px;">7. Personal Habits</h3>
          <p><strong>Smoking/Drinking/Tobacco:</strong> ${safe(formData.personalHabits)}</p>
          <p><strong>Follow house rules:</strong> ${safe(formData.followHouseRules)}</p>
        </div>
...
// Note: `escapeHtml` is imported from '@/lib/sanitize' at the top of this file.
    ...
    html: `
      <div style="font-family:system-ui,-apple-system,sans-serif;max-width:640px;margin:0 auto;">
        ...
        <div style="background:#f9fafb;padding:16px 20px;border-radius:8px;margin:16px 0;">
          ...
          <p style="margin:4px 0;"><strong>Phone:</strong> ${safe(formattedPhone)}</p>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto;">
        ...
        <div style="background-color: #e8f4fc; padding: 16px; border-radius: 8px; margin: 16px 0; border: 1px solid #b3d9f2;">
          ...
          <p style="margin: 0; word-break: break-all;">
            ${rawSource ? `<a href="${safe(sourceHref)}" target="_blank" rel="noopener noreferrer" style="color: #0369a1;">${safe(sourceDisplay)}</a>` : sourceDisplay}
          </p>
        </div>
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #333;">Contact</h3>
          <p><strong>Name:</strong> ${safe(nameSafe)}</p>
          <p><strong>Email:</strong> <a href="mailto:${safe(formData.email)}">${safe(formData.email)}</a></p>
          <p><strong>Phone:</strong> <a href="tel:${safe(formData.phone)}" style="text-decoration: none; color: #1e40af;">${safe(formattedPhone)}</a></p>
        </div>
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
          <h3 style="margin-top: 0; color: #333;">Care request</h3>
          <p><strong>Service line:</strong> ${safe(careLabelHtml)}</p>
          <p><strong>Locality / area:</strong> ${safe(localitySafe)}</p>
          <p><strong>Urgency:</strong> ${safe(urgencyLabel)}</p>
          <h4 style="color: #333;">Situation / patient brief</h4>
          <p style="white-space: pre-wrap;">${safe(escapeCareEmailHtml(formData.patientSummary))}</p>
          ${formData.notes?.trim() ? `<h4 style="color: #333;">Additional notes</h4><p style="white-space: pre-wrap;">${safe(escapeCareEmailHtml(formData.notes))}</p>` : ''}
        </div>
    ...
    const emailContent = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #334155;">Request Details</h3>
            ${requestId ? `<p><strong>Request ID:</strong> <span style="font-family: monospace; background-color: #e1e8f0; padding: 2px 6px; border-radius: 4px;">${safe(requestId)}</span></p>` : ''}
            <p><strong>Booking Type:</strong> <span style="background-color: #fce7f3; color: #e11d48; padding: 4px 8px; border-radius: 4px; font-weight: bold;">${safe(bookingTypeLabel)}</span></p>
            <p><strong>Stay Type:</strong> ${safe(userTypeLabel)}</p>
          </div>
          ...
          <div style="background-color: #fff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; margin: 20px 0;">
            ...
            ${formData.check_in_date ? `<p><strong>Check-in Date:</strong> ${safe(new Date(formData.check_in_date).toLocaleDateString('en-IN', { weekday: 'short', year: 'numeric', month: 'short', day: 'numeric' }))}</p>` : '<p><strong>Check-in Date:</strong> Not specified</p>'}
            ${formData.check_out_date ? `<p><strong>Check-out Date:</strong> ${safe(new Date(formData.check_out_date).toLocaleDateString('en-IN', { weekday: 'short', year: 'numeric', month: 'short', day: 'numeric' }))}</p>` : '<p><strong>Check-out Date:</strong> Not specified</p>'}
            ${formData.duration_days ? `<p><strong>Duration:</strong> ${safe(formData.duration_days)} ${formData.duration_days === 1 ? 'day' : 'days'}</p>` : ''}
          </div>
